 ...
 *
 * @export
 * @interface GetRestaurantMenuItemsResponse
 */
export interface GetRestaurantMenuItemsResponse {
     ...
     * @memberof GetRestaurantMenuItemsResponse
     */
    items: Array<RestaurantMenuItem>;
}

/**
 * Check if a given object implements the GetRestaurantMenuItemsResponse interface.
 */
export function instanceOfGetRestaurantMenuItemsResponse(value: object): value is GetRestaurantMenuItemsResponse {
    if (!('items' in value) || value['items'] === undefined) return false;
    return true;
}

export function GetRestaurantMenuItemsResponseFromJSON(json: any): GetRestaurantMenuItemsResponse {
    return GetRestaurantMenuItemsResponseFromJSONTyped(json, false);
}

export function GetRestaurantMenuItemsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetRestaurantMenuItemsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function GetRestaurantMenuItemsResponseToJSON(json: any): GetRestaurantMenuItemsResponse {
    return GetRestaurantMenuItemsResponseToJSONTyped(json, false);
}

export function GetRestaurantMenuItemsResponseToJSONTyped(value?: GetRestaurantMenuItemsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
