 ...
 *
 * @export
 * @interface RevokeClientTokensBody
 */
export interface RevokeClientTokensBody {
    /**
     * The end user whose outstanding client tokens should all be revoked.
     * @type {string}
     * @memberof RevokeClientTokensBody
     */
    endUserId: string;
}

/**
 * Check if a given object implements the RevokeClientTokensBody interface.
 */
export function instanceOfRevokeClientTokensBody(value: object): value is RevokeClientTokensBody {
...
export function RevokeClientTokensBodyFromJSON(json: any): RevokeClientTokensBody {
    return RevokeClientTokensBodyFromJSONTyped(json, false);
}

export function RevokeClientTokensBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): RevokeClientTokensBody {
    if (json == null) {
        return json;
    }
    return {
...
export function RevokeClientTokensBodyToJSON(json: any): RevokeClientTokensBody {
    return RevokeClientTokensBodyToJSONTyped(json, false);
}

export function RevokeClientTokensBodyToJSONTyped(value?: RevokeClientTokensBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
