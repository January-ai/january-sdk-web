...
/**
 * Check if a given object implements the DailyWaterTotal interface.
 */
export function instanceOfDailyWaterTotal(value: object): value is DailyWaterTotal {
    if (!('date' in value) || value['date'] === undefined) return false;
    if (!('total' in value) || value['total'] === undefined) return false;
    return true;
}

export function DailyWaterTotalFromJSON(json: any): DailyWaterTotal {
    return DailyWaterTotalFromJSONTyped(json, false);
}

export function DailyWaterTotalFromJSONTyped(json: any, ignoreDiscriminator: boolean): DailyWaterTotal {
    if (json == null) {
        return json;
    }
    return {
        ...
        'total': VolumeFromJSON(json['total']),
    };
}

export function DailyWaterTotalToJSON(json: any): DailyWaterTotal {
    return DailyWaterTotalToJSONTyped(json, false);
}

export function DailyWaterTotalToJSONTyped(value?: DailyWaterTotal | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'total': VolumeToJSON(value['total']),
    };
}
