...
import type { CorrectionFood } from './CorrectionFood.js';
import {
    CorrectionFoodFromJSON,
    CorrectionFoodFromJSONTyped,
    CorrectionFoodToJSON,
    CorrectionFoodToJSONTyped,
} from './CorrectionFood.js';
...
/**
 * Check if a given object implements the CorrectionDetection interface.
 */
export function instanceOfCorrectionDetection(value: object): value is CorrectionDetection {
    if (!('confidence' in value) || value['confidence'] === undefined) return false;
    if (!('food' in value) || value['food'] === undefined) return false;
    return true;
}

export function CorrectionDetectionFromJSON(json: any): CorrectionDetection {
    return CorrectionDetectionFromJSONTyped(json, false);
}

export function CorrectionDetectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CorrectionDetection {
    if (json == null) {
        return json;
    }
    return {
        ...
        'food': CorrectionFoodFromJSON(json['food']),
    };
}

export function CorrectionDetectionToJSON(json: any): CorrectionDetection {
    return CorrectionDetectionToJSONTyped(json, false);
}

export function CorrectionDetectionToJSONTyped(value?: CorrectionDetection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'food': CorrectionFoodToJSON(value['food']),
    };
}
