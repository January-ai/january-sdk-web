 ...
 *
 * @export
 * @interface CorrectionServing
 */
export interface CorrectionServing {
    /**
     * Catalog serving id. Pass it back as serving_id when logging this food.
     * @type {string}
     * @memberof CorrectionServing
     */
    id: string;
    /**
...
/**
 * Check if a given object implements the CorrectionServing interface.
 */
export function instanceOfCorrectionServing(value: object): value is CorrectionServing {
...
export function CorrectionServingFromJSON(json: any): CorrectionServing {
    return CorrectionServingFromJSONTyped(json, false);
}

export function CorrectionServingFromJSONTyped(json: any, ignoreDiscriminator: boolean): CorrectionServing {
    if (json == null) {
        return json;
    }
    return {
...
export function CorrectionServingToJSON(json: any): CorrectionServing {
    return CorrectionServingToJSONTyped(json, false);
}

export function CorrectionServingToJSONTyped(value?: CorrectionServing | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
