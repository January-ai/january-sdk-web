...
/**
 * Check if a given object implements the WaterLog interface.
 */
...
export function WaterLogFromJSON(json: any): WaterLog {
    return WaterLogFromJSONTyped(json, false);
}

export function WaterLogFromJSONTyped(json: any, ignoreDiscriminator: boolean): WaterLog {
    if (json == null) {
        return json;
    }
    return {
...
export function WaterLogToJSON(json: any): WaterLog {
    return WaterLogToJSONTyped(json, false);
}

export function WaterLogToJSONTyped(value?: WaterLog | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
