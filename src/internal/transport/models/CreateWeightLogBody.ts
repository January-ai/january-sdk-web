 ...
 */
export interface CreateWeightLogBody {
    /**
     *
     * @type {Weight}
...
/**
 * Check if a given object implements the CreateWeightLogBody interface.
 */
export function instanceOfCreateWeightLogBody(value: object): value is CreateWeightLogBody {
    if (!('weight' in value) || value['weight'] === undefined) return false;
    return true;
}

export function CreateWeightLogBodyFromJSON(json: any): CreateWeightLogBody {
    return CreateWeightLogBodyFromJSONTyped(json, false);
}

export function CreateWeightLogBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateWeightLogBody {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateWeightLogBodyToJSON(json: any): CreateWeightLogBody {
    return CreateWeightLogBodyToJSONTyped(json, false);
}

export function CreateWeightLogBodyToJSONTyped(value?: CreateWeightLogBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
