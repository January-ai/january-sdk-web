...
import type { ConsumedServing } from './ConsumedServing.js';
import {
    ConsumedServingFromJSON,
    ConsumedServingFromJSONTyped,
    ConsumedServingToJSON,
    ConsumedServingToJSONTyped,
} from './ConsumedServing.js';
...
export function LoggedFoodFromJSONTyped(json: any, ignoreDiscriminator: boolean): LoggedFood {
    ...
    return {
        ...
        'consumedServing': ConsumedServingFromJSON(json['consumed_serving']),
...
export function LoggedFoodToJSONTyped(value?: LoggedFood | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'consumed_serving': ConsumedServingToJSON(value['consumedServing']),
