 ...
 *
 * @export
 * @interface ClientTokenRevocationResult
 */
export interface ClientTokenRevocationResult {
    /**
     ...
     * @type {number}
     * @memberof ClientTokenRevocationResult
     */
    revokedCount: number;
}

/**
 * Check if a given object implements the ClientTokenRevocationResult interface.
 */
export function instanceOfClientTokenRevocationResult(value: object): value is ClientTokenRevocationResult {
    if ((!('revokedCount' in (value as Record<string, any>)) && !('revoked_count' in (value as Record<string, any>))) || ((value as Record<string, any>)['revokedCount'] === undefined && (value as Record<string, any>)['revoked_count'] === undefined)) return false;
    return true;
}

export function ClientTokenRevocationResultFromJSON(json: any): ClientTokenRevocationResult {
    return ClientTokenRevocationResultFromJSONTyped(json, false);
}

export function ClientTokenRevocationResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClientTokenRevocationResult {
    if (json == null) {
        return json;
    }
    return {

        'revokedCount': json['revoked_count'],
    };
}

export function ClientTokenRevocationResultToJSON(json: any): ClientTokenRevocationResult {
    return ClientTokenRevocationResultToJSONTyped(json, false);
}

export function ClientTokenRevocationResultToJSONTyped(value?: ClientTokenRevocationResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'revoked_count': value['revokedCount'],
    };
}
