...
import type { DailyWeight } from './DailyWeight.js';
import {
    DailyWeightFromJSON,
    DailyWeightFromJSONTyped,
    DailyWeightToJSON,
    DailyWeightToJSONTyped,
} from './DailyWeight.js';

/**
 *
 * @export
 * @interface ListWeightLogsResponse
 */
export interface ListWeightLogsResponse {
     ...
     * @type {Array<DailyWeight>}
     * @memberof ListWeightLogsResponse
     */
    items: Array<DailyWeight>;
}

/**
 * Check if a given object implements the ListWeightLogsResponse interface.
 */
export function instanceOfListWeightLogsResponse(value: object): value is ListWeightLogsResponse {
    if (!('items' in value) || value['items'] === undefined) return false;
    return true;
}

export function ListWeightLogsResponseFromJSON(json: any): ListWeightLogsResponse {
    return ListWeightLogsResponseFromJSONTyped(json, false);
}

export function ListWeightLogsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWeightLogsResponse {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(DailyWeightFromJSON)),
    };
}

export function ListWeightLogsResponseToJSON(json: any): ListWeightLogsResponse {
    return ListWeightLogsResponseToJSONTyped(json, false);
}

export function ListWeightLogsResponseToJSONTyped(value?: ListWeightLogsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(DailyWeightToJSON)),
    };
}
