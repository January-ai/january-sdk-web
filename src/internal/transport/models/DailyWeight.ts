...
/**
 * Check if a given object implements the DailyWeight interface.
 */
export function instanceOfDailyWeight(value: object): value is DailyWeight {
    if (!('date' in value) || value['date'] === undefined) return false;
    if (!('weight' in value) || value['weight'] === undefined) return false;
    return true;
}

export function DailyWeightFromJSON(json: any): DailyWeight {
    return DailyWeightFromJSONTyped(json, false);
}

export function DailyWeightFromJSONTyped(json: any, ignoreDiscriminator: boolean): DailyWeight {
    if (json == null) {
        return json;
    }
    return {
...
export function DailyWeightToJSON(json: any): DailyWeight {
    return DailyWeightToJSONTyped(json, false);
}

export function DailyWeightToJSONTyped(value?: DailyWeight | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
