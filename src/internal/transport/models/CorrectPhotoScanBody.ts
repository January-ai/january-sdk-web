...
import type { CorrectionAnalysis } from './CorrectionAnalysis.js';
import {
    CorrectionAnalysisFromJSON,
    CorrectionAnalysisFromJSONTyped,
    CorrectionAnalysisToJSON,
    CorrectionAnalysisToJSONTyped,
} from './CorrectionAnalysis.js';
...
export function CorrectPhotoScanBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CorrectPhotoScanBody {
    ...
    return {
        ...
        'analysis': CorrectionAnalysisFromJSON(json['analysis']),
...
export function CorrectPhotoScanBodyToJSONTyped(value?: CorrectPhotoScanBody | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'analysis': CorrectionAnalysisToJSON(value['analysis']),
