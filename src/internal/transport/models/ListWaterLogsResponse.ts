...
import type { DailyWaterTotal } from './DailyWaterTotal.js';
import {
    DailyWaterTotalFromJSON,
    DailyWaterTotalFromJSONTyped,
    DailyWaterTotalToJSON,
    DailyWaterTotalToJSONTyped,
} from './DailyWaterTotal.js';

/**
 *
 * @export
 * @interface ListWaterLogsResponse
 */
export interface ListWaterLogsResponse {
     ...
     * @type {Array<DailyWaterTotal>}
     * @memberof ListWaterLogsResponse
     */
    items: Array<DailyWaterTotal>;
}

/**
 * Check if a given object implements the ListWaterLogsResponse interface.
 */
export function instanceOfListWaterLogsResponse(value: object): value is ListWaterLogsResponse {
    if (!('items' in value) || value['items'] === undefined) return false;
    return true;
}

export function ListWaterLogsResponseFromJSON(json: any): ListWaterLogsResponse {
    return ListWaterLogsResponseFromJSONTyped(json, false);
}

export function ListWaterLogsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWaterLogsResponse {
    if (json == null) {
        return json;
    }
    return {

        'items': ((json['items'] as Array<any>).map(DailyWaterTotalFromJSON)),
    };
}

export function ListWaterLogsResponseToJSON(json: any): ListWaterLogsResponse {
    return ListWaterLogsResponseToJSONTyped(json, false);
}

export function ListWaterLogsResponseToJSONTyped(value?: ListWaterLogsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': ((value['items'] as Array<any>).map(DailyWaterTotalToJSON)),
    };
}
