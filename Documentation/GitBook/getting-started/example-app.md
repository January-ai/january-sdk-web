...
logs, water and weight logs, glucose prediction, user context, imperial/metric
controls, and local voice capture for food and restaurant search.
...
servings, voice capture → transcript, photo scan, Food Logs, Water & weight,
