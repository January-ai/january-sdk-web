...
import { optionTestId, type SegmentedOption } from './segmented-control'

export function ChipSelector<T extends string>({ label, name, options, value, onChange, className, testIdPrefix }: {
  label: string
  name: string
