...
See the [installation guide](https://docs.january.ai/web-sdk/web-sdk/getting-started/installation)
for package and runtime requirements.

## Documentation

The [Web SDK GitBook](https://docs.january.ai/web-sdk/web-sdk) covers the
...
the [backend token endpoint](https://docs.january.ai/web-sdk/web-sdk/getting-started/backend-token-endpoint).
